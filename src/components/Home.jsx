    ...
    <div>
      <section className='home' id='home'>
        <div className='content'>
          ...
          <img id='png' src="../src/assets/png-transparent-business-management-customer-service-eye-lead-generation-sorpresa-hand-service-girl-thumbnail-removebg-preview.png" alt='default png'/> 
